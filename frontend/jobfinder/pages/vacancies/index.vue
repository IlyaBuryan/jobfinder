            ...
            <nuxt-link :to="`/vacancies/${item.id}`" style="textDecoration:none">
              <div class="vacancy-item__block">
                ...
                <div class="vacancy-item__info">
                  ...
                  <div>
                    <div>Условия: {{ item.conditions }}</div>
                    <div>Обязанности: {{ item.duties}}</div>
                    <div>Требования: {{ item.requirements }}</div>
                  ...
                  <div class="vacancy-item__info_footer">
                    <div class="vacancy-item__info_footer-salary"></div>
                    <div class="vacancy-item__info_footer-education"></div>
                  </div>
                </div>
              </div>
            </nuxt-link>
