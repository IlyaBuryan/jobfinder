              ...
              <div v-if="permission">
                ...
                <p class="text-center">
                  <button
                    ...
                    @click="updateCompany"
                  >
                    Редактируйте информацию о своей компании.
                  </button>
                  <button
                    @click="deleteCompany"
                    class="btn btn-success btn-xl btn-round"
...
export default {
  ...
  methods: {
    fetchCompany() {
      ...
      axios
        .get(`${baseUrl()}/companyapp/${this.$route.query.id}/`, { headers })
        .then((response) => {
    ...
    updateCompany(event) {
      ...
      axios
        .patch(
          `${baseUrl()}/companyapp/${this.$route.query.id}/`,
          this.company,
          { headers }
        )
        .then((response) => {
    ...
    async deleteCompany(event) {
      ...
      console.log(headers);
      await axios
        .delete(`${baseUrl()}/companyapp/${this.$route.query.id}/`, { headers })
        .then((response) => {
          this.company = response.data;
        })
        .catch((error) => console.log(error));
