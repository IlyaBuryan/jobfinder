    ...
    <form class="form-data">
      <header class="page-header">
        <div class="container page-name">
          <h1 class="text-center">Отредактируйте свое резюме</h1>
        </div>
        ...
        <div class="container" v-if="permission == 'yes'">
          ...
          <form class="form_container">
            ...
            <div
              ...
              class="border border-info rounded exp"
            >
              <p><b>Ваш опыт работы</b></p>
              <br />
              <div class="form-group">
                <label for="organizationComp">Организация</label>
                <input
                  type="text"
                  id="organizationComp"
              ...
              <div class="form-group">
                <label for="startComp">Начало работы</label>
                <input
                  type="date"
                  id="startComp"
              ...
              <div class="form-group">
                <label for="endComp">Окончание работы</label>
                <input
                  type="date"
                  id="endComp"
              ...
              <div class="form-group">
                <label for="functionsComp">Обязанности</label>
                <textarea
                  id="infoComp"
...
export default {
  ...
  methods: {
    fetchResume() {
      ...
      axios
        .get(`${baseUrl()}/resume/${this.$route.query.id}/`, { headers })
        .then((response) => {
