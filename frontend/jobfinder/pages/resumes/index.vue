    ...
    <header class="header">
      <div class="head__container">
        ...
        <p class="lead text-center">
          Воспользуйтесь полями ниже для поиска подходящего резюме
        </p>
      </div>
              ...
              <div class="vacancy-item__block">
                <div class="vacancy-item__info">
                  ...
                  <div class="vacancy-item__info_descr">
                    <div>
                      <b>Данные:</b> {{ item.worker_info.first_name }}
                      {{ item.worker_info.last_name }}
                    </div>
                    <div><b>Телефон:</b> {{ item.worker_info.phone }}</div>
                  </div>
                  <br />
                  <div class="vacancy-item__info_footer">
                    <div class="vacancy-item__info_footer-city">
                      <b>О себе:</b> {{ item.info }}
                    </div>
                  </div>
                </div>
              </div>
